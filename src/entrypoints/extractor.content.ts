...
// 歌詞部分を抽出する関数
function cut(text: string, s: string, e: string, d: Array<{p: RegExp, r: string}>) {
...
function insertUi() {
  ...
  if (!window.location.href.includes("https://www.google.com/") || html.includes('<div jsname="WbKHeb">')) {
      // 以下の2つを入れるためのコンテナー
